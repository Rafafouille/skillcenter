		...
		<p>
			...
			<form id="rentreBDD">
				<table>
					...
					<tr>
						<td><label for="input_BDD_PREFIXE">Préfixe pour les tables <span title="Un péfixe peut être mis devant le nom des tables dans la BDD. Cela peut être pratique pour installer plusieurs fois SkillCenter sur une même BDD. Sinon, laisser vide."><img src="./sources/images/icone-info.png" alt="[i]"/></span>:</label></td>
						<td><input type="text" id="input_BDD_PREFIXE" name="BDD_PREFIXE" placeholder="Ex : cpt1_" value="<?php echo $_SESSION['BDD_PREFIXE'];?>"/></td>
					</tr>
				</table>
			</form>
